        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-4">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-cozy border border-white space-y-3">
              ...
              <textarea
                className="w-full mt-2 bg-theme-bg/40 rounded-2xl p-3.5 text-sm leading-relaxed border-none focus:ring-2 ring-theme-primary/20"
                rows={4}
        ...
        <div className="p-6 md:p-10 space-y-12">
          ...
          {activeTab === 'CONTENT' && (
            <div className="bg-white rounded-[2.5rem] p-6 md:p-7 shadow-cozy border border-theme-bg/60 space-y-3">
              ...
              <textarea
                className="w-full mt-3 bg-theme-bg/30 rounded-2xl p-4 text-sm leading-relaxed border-none focus:ring-2 ring-theme-primary/20"
                rows={4}
